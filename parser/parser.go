...
var binaryOperators = map[string]operator{
	...
	"not in":                  {20, left},
	"in":                      {20, left},
	"not case_insensitive_in": {20, left}, // like "not in" operator, but compare string case insensitively
	"case_insensitive_in":     {20, left}, // like "in" operator, but compare string case insensitively
	"matches":                 {20, left},
	"contains":                {20, left},
	"startsWith":              {20, left},
	"endsWith":                {20, left},
